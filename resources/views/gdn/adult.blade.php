...
<html>
    ...
    <body>
        ...
        <img src="{{ asset('image/IMG_4779.jpg') }}" class="protect"></img>
        ...
        <img src="{{ asset('image/IMG_4788.jpg') }}" class="protect"></img>
        ...
        <img src="{{ asset('image/IMG_4795.jpg') }}" class="protect"></img>
