...
<html>
    <head>
        ...
        <title>女子●生が暴露！？今話題のアプリとは…</title>
        <link href="{{ secure_asset('css/adult.css') }}" rel="stylesheet">
        <link href="https://use.fontawesome.com/releases/v5.6.1/css/all.css" rel="stylesheet">
    </head>
    <body>
        <img src="{{ asset('image/IMG_4770.jpg') }}" class="protect"></img>
        <img src="{{ asset('image/IMG_4771.jpg') }}" class="protect"></img>
        <img src="{{ asset('image/IMG_4772.jpg') }}" class="protect"></img>
        <img src="{{ asset('image/IMG_4773.jpg') }}" class="protect"></img>
        <img src="{{ asset('image/IMG_4774.jpg') }}" class="protect"></img>
        <img src="{{ asset('image/IMG_4775.jpg') }}" class="protect"></img>
        ...
        <a href="https://preaf.jp/pa.do?s=v04031&o=45765&guid=ON" target="_blank"><img src="{{ asset('image/IMG_4779.jpg') }}"></img></a>
        ...
        <img src="{{ asset('image/IMG_4783.jpg') }}" class="protect"></img>
        <img src="{{ asset('image/IMG_4784.jpg') }}" class="protect"></img>
        ...
        <a href="https://preaf.jp/pa.do?s=v04031&o=45765&guid=ON" target="_blank"><img src="{{ asset('image/IMG_4788.jpg') }}"></img></a>
        ...
        <a href="https://preaf.jp/pa.do?s=v04031&o=45765&guid=ON" target="_blank"><img src="{{ asset('image/kokoko-2.jpg') }}"></img></a>
