...
<html>
    <head>
        ...
        <title>無料クーポンGET【期間限定】</title>
        <link href="{{ secure_asset('css/tjad.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <div class="big-body">
            ...
            <div class="body-top">
                <h1><span>【期間限定】<br>無料クーポン配布（アプリ内）<br><br>ガチ素人の『裏ライブ』が今熱い！？</span></h1>
                ...
                <a href="./os" target="_blank" class="btn-square-shadow"><i class="fab fa-google"></i> 最短3分で開始 <i class="fas fa-external-link-alt"></i></a>
                ...
                <h1><span>いいね・フォロワー獲得の為のオナニー投稿も多数。</span></h1>
            </div>
